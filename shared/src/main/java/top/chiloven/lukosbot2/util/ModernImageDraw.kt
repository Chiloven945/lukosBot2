...
object ModernImageDraw {
    ...
    @JvmStatic
    fun defaultPalette(): Palette = lightPalette()

    @JvmStatic
    fun paletteFor(mode: ThemeMode): Palette = when (mode) {
    ...
    fun pill(
        ...
        val padX = 12
        val padY = 5
        val width = ImageTextUtils.measureTextRunAware(
            g,
            text,
            font,
            font,
