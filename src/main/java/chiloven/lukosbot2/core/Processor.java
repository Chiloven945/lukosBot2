...
/**
 * Defines the contract for components that transform an inbound {@link chiloven.lukosbot2.model.MessageIn} into
 * zero or more {@link chiloven.lukosbot2.model.MessageOut} results; the interface also unifies “no output”
